...
function cuboid_generator(shape_data){
    ...
    pointArray.push(p1);
    var p2 = vec3(shape_data["bottom_rightdown"][0], shape_data["bottom_rightdown"][1], shape_data["bottom_rightdown"][2]);
    pointArray.push(p2);
    var p3 = vec3(shape_data["bottom_leftup"][0], shape_data["bottom_leftup"][1] + shape_data["height"], shape_data["bottom_leftup"][2]);
    pointArray.push(p3);
    var p4 = vec3(shape_data["bottom_rightdown"][0], shape_data["bottom_rightdown"][1] + shape_data["height"], shape_data["bottom_rightdown"][2]);
    pointArray.push(p4);
    ...
    for(var i = 0; i < 36; i += 6){
        var tmp_arr = [pointArray[indice[i]], pointArray[indice[i + 1]], pointArray[indice[i + 2]], pointArray[indice[i + 5]]];
        normal_tmp = get_rectangle_normals(tmp_arr);
        for(var j = 0; j < 6; j++){
